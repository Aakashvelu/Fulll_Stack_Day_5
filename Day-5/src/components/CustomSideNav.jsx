        ...
        <Sidenav.Body style={{ backgroundColor: '#1d1d1d', color: 'white' }}>
          <Nav activeKey={activeKey} onSelect={setActiveKey}>
            ...
            <Nav.Menu placement="rightStart" eventKey="3" title="Courses" icon={<MagicIcon />}>
              <Nav.Item eventKey="3-1"><NavLink to={'/postcourse'}>Post Course</NavLink></Nav.Item>
              <Nav.Item eventKey="3-2"><NavLink to={'/deletecourse'}>Delete Course</NavLink></Nav.Item>
              <Nav.Item eventKey="3-3"><NavLink to={'/editcourse'}>Edit Course</NavLink></Nav.Item>
              <Nav.Item eventKey="3-4"><NavLink to={'/view'}>View Course</NavLink></Nav.Item>
            </Nav.Menu>
